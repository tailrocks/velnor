...
RUN --mount=type=cache,target=/root/.cargo/registry \
    ...
    curl -fsSL https://mise.run | MISE_VERSION="v2026.6.14" MISE_INSTALL_PATH=/opt/mise/bin/mise sh && \
    ...
    mise use --global rust@1.96.0 'cargo:cargo-nextest@0.9.137' 'cargo:rust-script@0.36.0' just@1.52.0 protoc@35.1 gh@2.94.0 && \
    mise reshim && \
