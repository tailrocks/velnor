...
- [ ] `actions/cache/usage` ≤ 8 GiB after one maintenance run — **not proven @ rev 25:** run [35091390936](https://github.com/tailrocks/velnor/actions/runs/35091390936) @ [`20221ab2`](https://github.com/tailrocks/velnor/commit/20221ab2) retention **SKIPPED** (`--repo` bug — not a real success); live **~10.7 GiB / 140 entries** (supersedes rev 24 pending dispatch [35090304019](https://github.com/tailrocks/velnor/actions/runs/35090304019))
...
#### Rev 25 delta @ [`d2e23dd2`](https://github.com/tailrocks/velnor/commit/d2e23dd2) (2026-09-16)
...
| Restore `--repo`/`-R` + pin on `main` | V | [`d2e23dd2`](https://github.com/tailrocks/velnor/commit/d2e23dd2): maintenance `--repo` + nightly `-R` re-restored; pin [`f5c8466d`](https://github.com/tailrocks/velnor/commit/f5c8466d) (carried from rev 24) |
| Maintenance retention run post-restore | C | run [35091390936](https://github.com/tailrocks/velnor/actions/runs/35091390936) @ [`20221ab2`](https://github.com/tailrocks/velnor/commit/20221ab2): retention **SKIPPED** (`--repo` bug) — **not** proof of ≤8 GiB |
| Live GHA cache account | C | `gh api …/actions/cache/usage` @ rev 25: **~10.7 GiB / 140 entries** — exceeds 8 GiB internal budget |
| `velnor-workflow` clippy gate | C | pending fix: `renovate.rs`, `ir.rs`, `lib.rs` (`cargo clippy -p velnor-workflow --all-targets -- -D warnings` not clean) |
| §16 Phase 0 gate: 3× consecutive green `ci-main` | C | streak **0/3** @ rev 25 — still open (last failure [35090384230](https://github.com/tailrocks/velnor/actions/runs/35090384230) @ [`cd6ea90d`](https://github.com/tailrocks/velnor/commit/cd6ea90d)) |
| §16 Phase 0 gate: `actions/cache/usage` ≤ 8 GiB | C | retention not proven; live account **~10.7 GiB / 140 entries** |
