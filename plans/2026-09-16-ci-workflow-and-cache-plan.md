...
Status: **in progress** — `main` @ [`66cfa4fa`](https://github.com/tailrocks/velnor/commit/66cfa4fa) (rev 26: #896 **v0.1.275** released (includes [`7ab8d438`](https://github.com/tailrocks/velnor/commit/7ab8d438) mask fix); #894 pin converge @ [`5623be55`](https://github.com/tailrocks/velnor/commit/5623be55); #891 maintenance `--repo` @ [`d2e23dd2`](https://github.com/tailrocks/velnor/commit/d2e23dd2); Phase 1 GitHub exact hits **VERIFIED** [35075927349](https://github.com/tailrocks/velnor/actions/runs/35075927349)/[35066240941](https://github.com/tailrocks/velnor/actions/runs/35066240941); clippy **VERIFIED** [35096781382](https://github.com/tailrocks/velnor/actions/runs/35096781382); macOS **4/4** @ PID 83457 (currently **0/4** offline); ci-main streak **pending** — [35096781382](https://github.com/tailrocks/velnor/actions/runs/35096781382)/[35097924422](https://github.com/tailrocks/velnor/actions/runs/35097924422)/[35097942733](https://github.com/tailrocks/velnor/actions/runs/35097942733); operational_store RCA: Sentry dogfood **v0.1.274** → deploy **v0.1.275**; cache **~10.69 GiB / ~100 entries**).
...
- [ ] 3 consecutive `ci-main` runs conclude `success`; `Control / Planning` and `Policy` green — **pending @ rev 26:** streak candidate chain [35096781382](https://github.com/tailrocks/velnor/actions/runs/35096781382) @ [`0084d561`](https://github.com/tailrocks/velnor/commit/0084d561) → [35097924422](https://github.com/tailrocks/velnor/actions/runs/35097924422) @ [`3768cb1d`](https://github.com/tailrocks/velnor/commit/3768cb1d) → [35097942733](https://github.com/tailrocks/velnor/actions/runs/35097942733) @ [`5623be55`](https://github.com/tailrocks/velnor/commit/5623be55) — Policy + velnor-workflow green, `ci-required` queued; last completed failure [35093268133](https://github.com/tailrocks/velnor/actions/runs/35093268133) @ [`2ca16370`](https://github.com/tailrocks/velnor/commit/2ca16370): 3× Velnor `operational_store` rejections (RCA: Sentry **v0.1.274** lacks [`7ab8d438`](https://github.com/tailrocks/velnor/commit/7ab8d438) → `store.masks`; fix: deploy **v0.1.275** #896 + restart dogfood)
...
- [ ] `actions/cache/usage` ≤ 8 GiB after one maintenance run — **not proven @ rev 26:** #891 merged @ [`d2e23dd2`](https://github.com/tailrocks/velnor/commit/d2e23dd2); `--repo` gate **WORKING**; retention **SKIPPED** on [35097112698](https://github.com/tailrocks/velnor/actions/runs/35097112698)/[35097943443](https://github.com/tailrocks/velnor/actions/runs/35097943443) (ci-main in_progress); live **~10.69 GiB / ~100 entries** @ rev 26 (supersedes rev 25 ~10.53 GiB)
...
| PR #882 merge without rebase | C | **HIGH** regression risk — 22 commits behind main, generator rev 48, lacks `--repo`/`-R` fixes |
...
| Maintenance retention post-#891 | U | runs [35097112698](https://github.com/tailrocks/velnor/actions/runs/35097112698)/[35097943443](https://github.com/tailrocks/velnor/actions/runs/35097943443): gate **WORKING**, retention **SKIPPED** (ci-main/nightly in_progress) — ≤8 GiB not proven |
| Live GHA cache account | C | `gh api …/actions/cache/usage` @ rev 26: **11,475,426,214 B / ~100 entries** (~10.69 GiB) — exceeds 8 GiB internal budget |
...
| §16 Phase 0 gate: 3× consecutive green `ci-main` | C | streak **0/3** @ rev 26 — latest completed [35093268133](https://github.com/tailrocks/velnor/actions/runs/35093268133) @ [`2ca16370`](https://github.com/tailrocks/velnor/commit/2ca16370): Policy PASS, 3× Velnor `operational_store` rejections; 5× queued backlog |
...
| §16 Phase 0 gate: `actions/cache/usage` ≤ 8 GiB | C | retention not proven; live account **~10.69 GiB** |
