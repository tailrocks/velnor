...
#### Rev 14 delta @ `0a6ded8e` (2026-09-16)
...
| Pins @ `0a6ded8e` (D19) | V | `.github-gen/velnor-workflow.toml:9`; `ci-policy.yml:51,71,93`; single pin commit at the end of the series, touching no Rust source; `--check` exit 0 with HEAD ≠ pin |
