...
- [x] P0-8: `nightly.yml` dispatches `ci-main@main` (`Control / Dispatch ci-main`) — **VERIFIED @ rev 16 on `main`:** 112 lines @ [`7171fe01`](https://github.com/tailrocks/velnor/commit/7171fe01) (fix [`4a1ab4a1`](https://github.com/tailrocks/velnor/commit/4a1ab4a1) + pin [`7171fe01`](https://github.com/tailrocks/velnor/commit/7171fe01))
...
| P0-8 nightly dispatches `ci-main@main` for mbx saves | V | pre-merge on `main`: **FAIL** (monolithic nightly, no dispatcher); post-merge **V** @ [`7171fe01`](https://github.com/tailrocks/velnor/commit/7171fe01): `nightly.yml:48-49` `Control / Dispatch ci-main`, 112 lines ([`4a1ab4a1`](https://github.com/tailrocks/velnor/commit/4a1ab4a1) + pin) |
