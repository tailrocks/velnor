...
Status: **in progress** — `main` @ [`0084d561`](https://github.com/tailrocks/velnor/commit/0084d561) (rev 25: nightly [35090298803](https://github.com/tailrocks/velnor/actions/runs/35090298803) VERIFIED @ [`6c8e1d7b`](https://github.com/tailrocks/velnor/commit/6c8e1d7b) 6m54s; maintenance [35093685237](https://github.com/tailrocks/velnor/actions/runs/35093685237)/[35097112698](https://github.com/tailrocks/velnor/actions/runs/35097112698) `--repo` gate **WORKING** but **SKIPPED** (ci-main in_progress); cache **~10.53 GiB / 102 entries** (>8 GiB budget); clippy fixed @ [`2ca16370`](https://github.com/tailrocks/velnor/commit/2ca16370)+[`0084d561`](https://github.com/tailrocks/velnor/commit/0084d561); pin [`2ca16370`](https://github.com/tailrocks/velnor/commit/2ca16370) via #893; ci-main streak **0/3** — run [35093268133](https://github.com/tailrocks/velnor/actions/runs/35093268133) Policy PASS, velnor-workflow Velnor clippy fail pre-fix).
...
| `velnor-workflow` clippy gate | V | [`2ca16370`](https://github.com/tailrocks/velnor/commit/2ca16370) lib + [`0084d561`](https://github.com/tailrocks/velnor/commit/0084d561) test-profile fixes; local `cargo clippy --all-targets -D warnings` clean; CI pending [35096781382](https://github.com/tailrocks/velnor/actions/runs/35096781382) |
| §16 Phase 0 gate: 3× consecutive green `ci-main` | C | streak **0/3** @ rev 25 — run [35093268133](https://github.com/tailrocks/velnor/actions/runs/35093268133) @ [`2ca16370`](https://github.com/tailrocks/velnor/commit/2ca16370): Policy PASS, velnor-workflow Velnor clippy fail (pre-`0084d561`), 3× `operational_store` rejections |
