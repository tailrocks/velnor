...
- [ ] 3 consecutive `ci-main` runs conclude `success`; `Control / Planning` and `Policy` green — **0/3 @ rev 27:** historical 2/3 broken @ [35097942733](https://github.com/tailrocks/velnor/actions/runs/35097942733); since then [35100329067](https://github.com/tailrocks/velnor/actions/runs/35100329067) **success** then 4× failure (operational_store + runner disconnect + #899 `pin-reachable`); #898 @ [`776c84c7`](https://github.com/tailrocks/velnor/commit/776c84c7) fixes Policy; deploy **v0.1.275** #896 pending on Sentry
...
- [ ] `actions/cache/usage` ≤ 8 GiB after one maintenance run — **retention EXECUTED @ rev 26** [35103870683](https://github.com/tailrocks/velnor/actions/runs/35103870683): 10 evictions, `failed_evictions=0`, `summary.json` `total_bytes=11164332683` pre-eviction; live **~9.7 GiB / 195 entries** post-run — still **>8 GiB budget**
