...
Status: **in progress** — branch `plan/ci-workflow-and-cache` @ `4f0bca6f` (pin `75707ac4`; PR [#872](https://github.com/tailrocks/velnor/pull/872); stable green @ run 35039991442 @ `8cc755fd`; latest run 35046368486 failed `velnor-rust-velnor-client`/`velnor-rust-velnor-render` Velnor unit checks; §16 post-merge + fleet ops gates open).  
...
| Run 35046368486 @ `4f0bca6f` | P | `Rust · velnor-client / Velnor` + `Rust · velnor-render / Velnor` `Run unit checks` failure; `ci-required` failed on `velnor-rust-velnor-client`; rerun queued; not generator/policy regression (local `policy` 11/11 PASS, `--check` green, 449 tests pass) |
