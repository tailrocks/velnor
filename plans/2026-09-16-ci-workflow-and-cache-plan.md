...
- [ ] `actions/cache/usage` ≤ 8 GiB after one maintenance run — **not proven @ rev 25:** runs [35093685237](https://github.com/tailrocks/velnor/actions/runs/35093685237)/[35097112698](https://github.com/tailrocks/velnor/actions/runs/35097112698) `--repo` gate **WORKING** but retention **SKIPPED** (ci-main in_progress); live **~10.53 GiB / 102 entries** (supersedes [35091390936](https://github.com/tailrocks/velnor/actions/runs/35091390936) `--repo` bug @ [`20221ab2`](https://github.com/tailrocks/velnor/commit/20221ab2))
