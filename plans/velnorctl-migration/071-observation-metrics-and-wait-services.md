...
2. Collect live host/instance/slot/job/storage snapshots with explicit source
   times and unavailable fields.
...
4. Test event ordering, reconnect, cursor expiry, metric unavailability,
   terminal-before-subscribe races, and bounded shutdown.
...
- [ ] Timeout and failed-condition outcomes are non-zero-ready typed results.
