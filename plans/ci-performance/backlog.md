...
| Current preview release prerequisites | Main `9e5c0eb2` CI passes, preview `35504500719` fails: ARM job lacks `aarch64-linux-gnu-gcc`; amd64 runner build rejects one dirty path | Re-fetch PR #960/#962 heads and inspect actual prerequisites/source identity before reuse; retain ARM packaging and clean-tree enforcement | Next available implementation agent after rollback/policy unit |
