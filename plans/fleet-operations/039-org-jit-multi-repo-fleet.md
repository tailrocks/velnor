...
jackin-project. Tailrocks begins with a removal-free reviewed diff: its selected
set contains the 18 canonical repositories plus `tailrocks/velnor-actions`,
whose approved reusable workflows directly define Velnor jobs. Repository
allowlists are the generated direct-workflow closure, not the 28-repository
class map alone.
