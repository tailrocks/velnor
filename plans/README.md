...
| 043 | Job lifecycle latency (async finalize, pre-create, JIT overlap) | P1 | L | — | V1.9/V1.10/V1.12 | IN PROGRESS |
| 044 | Git-mirror store + reflink copies | P1 | M | 035 | V1.11/V1.13 | IN PROGRESS |
