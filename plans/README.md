...
| 057 | tailrocks/tablerock | 3 | S | — | IN PROGRESS — trunk `7ba2873` retains the repaired strict-lint/Redis fixture baseline and adds its native macOS checkpoint plus transitive XCFramework link metadata; 768/768 nextest, strict clippy, actionlint, and the shape-aware estate audit pass. Native run `29813531027` is active; V-B/V-C waits the org-fleet migration. |
