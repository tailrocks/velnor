...
| 057 | tailrocks/tablerock | 3 | S | — | BLOCKED — clean current trunk including local `5c37304`/`9e32138` fails the mandatory strict-clippy gate with 191 errors; plan 057 forbids landing red CI and requires an operator decision before source repair |
