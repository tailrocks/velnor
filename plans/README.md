...
| 049 | jackin-project/jackin (stacks on PR #810) | 1 | L | 047 (pattern) | IN PROGRESS — PR #810 head `a27fcda` is pushed; standalone audit has zero errors, active commands are nextest-only, actionlint and 2,182/2,182 affected tests pass. Fleet proof and approval of `docs/capability-proposal-attest-build-provenance-v4.md` remain |
