...
1. [Install and run the first job](/docs/getting-started)
2. [Operate a node](/docs/guides/operator)
3. [Observe health, jobs, logs, events, and telemetry](/docs/operations/observability)
4. [Diagnose failures by lifecycle stage](/docs/getting-started#if-the-first-job-does-not-run)
5. [Understand the architecture and job flow](/docs/concepts/architecture)
6. [Check supported interfaces and known limits](/docs/reference/interface)

## Choose by task

| Need | Read |
| --- | --- |
| Install, configure, register, and run a first workflow | [Getting started](/docs/getting-started) |
| Configure labels, scope, slots, and backend | [Operator guide](/docs/guides/operator) |
| Understand GitHub communication and execution | [Architecture](/docs/concepts/architecture), [Execution](/docs/guides/execution), [Integrations](/docs/reference/integrations) |
| Inspect a running node | [Observability](/docs/operations/observability), [CLI/interface reference](/docs/reference/interface) |
| Investigate a failed or stuck job | [Getting started diagnosis](/docs/getting-started#if-the-first-job-does-not-run), [Execution](/docs/guides/execution) |
| Understand credentials, isolation, and persisted data | [Security and data](/docs/operations/security-and-data) |
| Look up commands and protocol details | [Interface reference](/docs/reference/interface), [Runner protocol](/docs/reference/runner-protocol) |
| Build, test, or maintain Velnor | [Development](/docs/guides/development), [Contributing](/docs/guides/contributing) |
