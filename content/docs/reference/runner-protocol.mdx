...
The [architecture overview](/docs/concepts/architecture) explains ownership and
data flow. The [interface reference](/docs/reference/interface) lists the currently exposed
