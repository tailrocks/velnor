...
> Navigation: [← Index](/docs) · **Glossary** · [Next: Architecture →](/docs/concepts/architecture)
...
Start with [architecture](/docs/concepts/architecture) for the relationships among these
terms, then [execution](/docs/guides/execution) for the job lifecycle.
