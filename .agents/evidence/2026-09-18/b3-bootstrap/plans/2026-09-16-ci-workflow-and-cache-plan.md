...
Status: **in progress** — `main` @ [`b9c3156c`](https://github.com/tailrocks/velnor/commit/b9c3156c) (rev 28: pin `92c34786` via #900/#902; ci-main streak **0/3** — last green [35100329067](https://github.com/tailrocks/velnor/actions/runs/35100329067); 7× failure since (operational_store + `default_rows_render_the_legacy_release_surface` @ [35109161987](https://github.com/tailrocks/velnor/actions/runs/35109161987) @ [`776c84c7`](https://github.com/tailrocks/velnor/commit/776c84c7)); 4 queued; operational_store blocking until **v0.1.275** deploy; maintenance [35103870683](https://github.com/tailrocks/velnor/actions/runs/35103870683) EXECUTED + [35105803721](https://github.com/tailrocks/velnor/actions/runs/35105803721) enforce fail + [35109165192](https://github.com/tailrocks/velnor/actions/runs/35109165192)/[35109835682](https://github.com/tailrocks/velnor/actions/runs/35109835682) PR success; cache **~10.5 GiB / 111 entries**).
Date: 2026-09-16 (rev 27: #898 mold + pin `9466fc71`; #899/#900 pin chain → `92c34786`; rev 26: #896 v0.1.275; #894 @ [`5623be55`](https://github.com/tailrocks/velnor/commit/5623be55); #891 @ [`d2e23dd2`](https://github.com/tailrocks/velnor/commit/d2e23dd2); macOS 4/4; operational_store RCA; rev 25: Phase 1 GitHub PASS + clippy CI verified; rev 22: #878/#879 regen broke Phase 0 @ [`1279c4f9`](https://github.com/tailrocks/velnor/commit/1279c4f9), restored via #884; rev 18: D18 read-through overlay replaced by a copy seed of the `pr` Cargo store, PR writes persist and are host-shared; rev 17: post-push verifier 4/4 PASS @ `c23d7e8a`; P0-8 pre-merge FAIL superseded; ci-main 35059608031 Planning `--force` fix; YAML drift gate literals expected expansion; rev 16: PR #872 merged @ `364347e9`; P0-8 nightly dispatcher on `main` @ `7171fe01`; rev 15: third green `ci-required` rollup @ `1e552afe`; rev 14: pin-decoupled policy validator + config-only trust-gated emission + `velnor-host-docker` online; rev 13: DCO sign-off restored; rev 12: first full green `ci-required` PR rollup @ `8cc755fd` run 35039991442; rev 11: input-parameterized O(1) kind reusables + template-memory ceiling + actionlint in Policy + revision-proven D19 guard (`--revision`) + local `setup-velnor-workflow` for the owner + runner manifest self-pin removed, pin `17b441c1` @ `8f41f2dd`; rev 10: trust-gated aggregate skip @ `81104ba8`; rev 9: Velnor prepare-cargo prefetch + clippy @ `28b528d8` (superseded by rev 11); rev 8: prefetch package name @ `284f1091`; rev 7: docker collapsed skip @ `8e1ae640`; rev 6: kind file sharding @ `6c51eceb` (superseded by rev 11); rev 5 collapsed verify runtime + pin `8decfeeb` @ `9c1211d7`; rev 4 D19 install fix @ `ad76f4a`; rev 3 `c273707d`).
...
- [ ] 3 consecutive `ci-main` runs conclude `success`; `Control / Planning` and `Policy` green — **0/3 @ rev 28:** historical 2/3 broken @ [35097942733](https://github.com/tailrocks/velnor/actions/runs/35097942733); since then [35100329067](https://github.com/tailrocks/velnor/actions/runs/35100329067) **success** then 7× failure (operational_store, runner disconnect, #899 `pin-reachable`, `default_rows_render_the_legacy_release_surface` @ [35109161987](https://github.com/tailrocks/velnor/actions/runs/35109161987) @ [`776c84c7`](https://github.com/tailrocks/velnor/commit/776c84c7)); 4 queued ([35109846029](https://github.com/tailrocks/velnor/actions/runs/35109846029), [35112453677](https://github.com/tailrocks/velnor/actions/runs/35112453677), [35113415790](https://github.com/tailrocks/velnor/actions/runs/35113415790), [35113682015](https://github.com/tailrocks/velnor/actions/runs/35113682015)); pin `92c34786` via #900/#902; deploy **v0.1.275** #896 pending on Sentry
...
- [x] Nightly completes in < 2 h (no 24 h queue) — **VERIFIED @ rev 25:** run [35090298803](https://github.com/tailrocks/velnor/actions/runs/35090298803) @ [`6c8e1d7b`](https://github.com/tailrocks/velnor/commit/6c8e1d7b): success **6m54s**
- [ ] `actions/cache/usage` ≤ 8 GiB after one maintenance run — **retention EXECUTED @ rev 26** [35103870683](https://github.com/tailrocks/velnor/actions/runs/35103870683): 10 evictions, `failed_evictions=0`, `summary.json` `total_bytes=11164332683` pre-eviction; live **~10.5 GiB / 111 entries** @ rev 28 (`11239879566` bytes) — still **>8 GiB budget**
...
- [x] Same-repo PR + stable lockfile: rustup/cargo exact hit — **VERIFIED @ rev 25:** ci-main [35075927349](https://github.com/tailrocks/velnor/actions/runs/35075927349) @ [`7e02fd6b`](https://github.com/tailrocks/velnor/commit/7e02fd6b) **13/13** GitHub Rust jobs `rustup=exact,cargo=exact`; [35066240941](https://github.com/tailrocks/velnor/actions/runs/35066240941) @ [`03f9409b`](https://github.com/tailrocks/velnor/commit/03f9409b) **13/13** exact; PRs [#876](https://github.com/tailrocks/velnor/pull/876)/[#873](https://github.com/tailrocks/velnor/pull/873)/[#875](https://github.com/tailrocks/velnor/pull/875) corroborate
- [x] Parallel PRs: GHA entry count stable (no `mise-v1-*`/`velnor-workflow-v1-*` growth on PR refs) — **VERIFIED @ rev 25:** snapshot **80 entries / ~9.99 GiB**; `mise-v1*`: 2 on main, 0 on PR refs; `velnor-workflow-v1*`: 0 total; `velnor-workflow-v2*`: 7 on main, 0 on PR refs; 41 PR-ref entries all `buildkit-blob-*` (docker), not target families
...
- [ ] 7 daily maintenance runs: `total_bytes <= 8589934592`, `failed_evictions == 0` — **1/7 @ rev 28:** [35103870683](https://github.com/tailrocks/velnor/actions/runs/35103870683) valid (`failed_evictions=0`); [35105803721](https://github.com/tailrocks/velnor/actions/runs/35105803721) retention EXECUTED but **enforce failed** (~996 MiB over budget post-eviction); PR-triggered [35109165192](https://github.com/tailrocks/velnor/actions/runs/35109165192)+[35109835682](https://github.com/tailrocks/velnor/actions/runs/35109835682) success (prune only); [35113416155](https://github.com/tailrocks/velnor/actions/runs/35113416155)+[35113757030](https://github.com/tailrocks/velnor/actions/runs/35113757030) pending
...
| Phase 0 gate: 3× green `ci-main` on `main` | V | **3/3** @ rev 20: [35066240941](https://github.com/tailrocks/velnor/actions/runs/35066240941) @ `03f9409b`, [35069637566](https://github.com/tailrocks/velnor/actions/runs/35069637566) @ `8a29a9f2`, [35070325902](https://github.com/tailrocks/velnor/actions/runs/35070325902) @ `8c5ce050`; Planning + Policy + `ci-required` success on all three |
...
#### Rev 20 delta @ `8c5ce050` (2026-09-16)

| Claim | Verdict | Evidence |
| --- | --- | --- |
| cargo-deny v2 verify + cache key | V | [`7a2c0f19`](https://github.com/tailrocks/velnor/commit/7a2c0f19): `velnor-cargo-bin-v2-…`; verify probes tool `--version` and `cargo "$subcommand" --version`; contract fixture @ [`03f9409b`](https://github.com/tailrocks/velnor/commit/03f9409b) |
| PR [#874](https://github.com/tailrocks/velnor/pull/874) merged | V | [`833d8bf4`](https://github.com/tailrocks/velnor/commit/833d8bf4): mbx store budget, revision-addressed runtime installs, full-history policy checkouts |
| PR [#873](https://github.com/tailrocks/velnor/pull/873) merged | V | [`8a29a9f2`](https://github.com/tailrocks/velnor/commit/8a29a9f2): D18 `pr` copy seed (rev 19); second green `ci-main` [35069637566](https://github.com/tailrocks/velnor/actions/runs/35069637566) |
| PR [#875](https://github.com/tailrocks/velnor/pull/875) merged | V | [`8c5ce050`](https://github.com/tailrocks/velnor/commit/8c5ce050): regenerate at pin `7a2c0f19`; third green `ci-main` [35070325902](https://github.com/tailrocks/velnor/actions/runs/35070325902) |
| §16 Phase 0 gate: 3× consecutive green `ci-main` | V | runs [35066240941](https://github.com/tailrocks/velnor/actions/runs/35066240941), [35069637566](https://github.com/tailrocks/velnor/actions/runs/35069637566), [35070325902](https://github.com/tailrocks/velnor/actions/runs/35070325902) — all `conclusion: success`; Planning + Policy + `ci-required` green |
| Live GHA cache account | U | `gh api …/actions/cache/usage` @ rev 20: **10,368,457,977 B / 38 entries** (~9.7 GiB; still > 8 GiB budget) |
| §16 Phase 1 live cache evidence | U | Velnor jobs still annotate `Cold cache layer(s): mbx`; exact-hit / `host_warm` log extraction not yet recorded |

#### Rev 21 delta @ `2f51ebf3` (2026-09-16)

| Claim | Verdict | Evidence |
| --- | --- | --- |
| Fourth green `ci-main` (doc-only) | V | [35075927349](https://github.com/tailrocks/velnor/actions/runs/35075927349) @ `7e02fd6b`: success |
| Composite report telemetry | V | [`6ea138c1`](https://github.com/tailrocks/velnor/commit/6ea138c1): pass `ci_lane`, `host_warm_layers`, `cache_*` as action **inputs** (supersedes `${{ env.* }}` @ [`3a0829fc`](https://github.com/tailrocks/velnor/commit/3a0829fc); run [35077827269](https://github.com/tailrocks/velnor/actions/runs/35077827269) showed empty composite env) |
| Maintenance retention gate `--json` | V | [`3a0829fc`](https://github.com/tailrocks/velnor/commit/3a0829fc): `gh run list … --json databaseId --jq 'length'`; prior [35075630102](https://github.com/tailrocks/velnor/actions/runs/35075630102), [35077294262](https://github.com/tailrocks/velnor/actions/runs/35077294262) failed gate with `cannot use --jq without specifying --json` |
...
#### Rev 24 delta @ [`d2e23dd2`](https://github.com/tailrocks/velnor/commit/d2e23dd2) (2026-09-16; restore after [`06e7fa1b`](https://github.com/tailrocks/velnor/commit/06e7fa1b))
...
| PR [#889](https://github.com/tailrocks/velnor/pull/889)/[#887](https://github.com/tailrocks/velnor/pull/887) regressed `--repo`/`-R` | C | pin reverted to [`2678913a`](https://github.com/tailrocks/velnor/commit/2678913a) @ [`06e7fa1b`](https://github.com/tailrocks/velnor/commit/06e7fa1b); YAML fixes dropped |
| Restore `--repo`/`-R` + pin on `main` | V | [`d2e23dd2`](https://github.com/tailrocks/velnor/commit/d2e23dd2): maintenance `--repo` + nightly `-R` re-restored; pin [`f5c8466d`](https://github.com/tailrocks/velnor/commit/f5c8466d) |
...
| Live GHA cache account | U | `gh api …/actions/cache/usage` @ rev 24: **~9.78 GiB** — retention not proven |
| Maintenance retention run | U | [35090304019](https://github.com/tailrocks/velnor/actions/runs/35090304019) **skipped** (producers in progress); **dispatch pending** post-restore @ [`d2e23dd2`](https://github.com/tailrocks/velnor/commit/d2e23dd2) |

#### Rev 25 delta @ [`0084d561`](https://github.com/tailrocks/velnor/commit/0084d561) (2026-09-16)

| Claim | Verdict | Evidence |
| --- | --- | --- |
| Nightly completes in < 2 h | V | run [35090298803](https://github.com/tailrocks/velnor/actions/runs/35090298803) @ [`6c8e1d7b`](https://github.com/tailrocks/velnor/commit/6c8e1d7b): success **6m54s** (carried from rev 24) |
| Restore `--repo`/`-R` + pin on `main` | V | [`d2e23dd2`](https://github.com/tailrocks/velnor/commit/d2e23dd2) restore preserved through #892/#893; pin [`2ca16370`](https://github.com/tailrocks/velnor/commit/2ca16370) @ [`0936b941`](https://github.com/tailrocks/velnor/commit/0936b941) |
| Maintenance `--repo` gate executes without git error | V | runs [35093685237](https://github.com/tailrocks/velnor/actions/runs/35093685237)/[35097112698](https://github.com/tailrocks/velnor/actions/runs/35097112698) @ [`2ca16370`](https://github.com/tailrocks/velnor/commit/2ca16370): gate uses `--repo "$GITHUB_REPOSITORY"` cleanly |
| Maintenance retention run post-restore | U | runs [35093685237](https://github.com/tailrocks/velnor/actions/runs/35093685237)/[35097112698](https://github.com/tailrocks/velnor/actions/runs/35097112698): retention **SKIPPED** (ci-main in_progress at gate time) — **not** proof of ≤8 GiB |
| Live GHA cache account | C | `gh api …/actions/cache/usage` @ rev 25: **~10.53 GiB / 102 entries** — exceeds 8 GiB internal budget |
| `velnor-workflow` clippy gate | V | [`2ca16370`](https://github.com/tailrocks/velnor/commit/2ca16370) lib + [`0084d561`](https://github.com/tailrocks/velnor/commit/0084d561) test-profile fixes; CI [35096781382](https://github.com/tailrocks/velnor/actions/runs/35096781382): GitHub + Velnor lanes **success** |
| §16 Phase 1 GitHub exact hits | V | [35075927349](https://github.com/tailrocks/velnor/actions/runs/35075927349) 13/13 exact; [35066240941](https://github.com/tailrocks/velnor/actions/runs/35066240941) 13/13 exact; parallel-PR entry count stable |
| §16 Phase 0 gate: 3× consecutive green `ci-main` | U | streak **pending** @ rev 25 — [35096781382](https://github.com/tailrocks/velnor/actions/runs/35096781382)/[35097924422](https://github.com/tailrocks/velnor/actions/runs/35097924422)/[35097942733](https://github.com/tailrocks/velnor/actions/runs/35097942733) Policy + velnor-workflow green, `ci-required` queued |
| Pin converge #894 | V | [`5623be55`](https://github.com/tailrocks/velnor/commit/5623be55): pin [`0084d561`](https://github.com/tailrocks/velnor/commit/0084d561); `--repo`/`-R` preserved |
| §16 Phase 0 gate: `actions/cache/usage` ≤ 8 GiB | C | retention not proven; live account **~10.53 GiB / 102 entries** |
| PR #882 merge without rebase | C | **HIGH** regression risk — closed/superseded; do not reopen |
| §16 Phase 0 gate: 3× consecutive green `ci-main` | C | streak **2/3** @ rev 26 — [35096781382](https://github.com/tailrocks/velnor/actions/runs/35096781382)+[35097924422](https://github.com/tailrocks/velnor/actions/runs/35097924422) success; broken @ [35097942733](https://github.com/tailrocks/velnor/actions/runs/35097942733) runner disconnect |
| Maintenance retention EXECUTED post-fix | V | [35103870683](https://github.com/tailrocks/velnor/actions/runs/35103870683): steps 6–11 executed, 10 evictions, `failed_evictions=0`, artifact `summary.json` |
| Live GHA cache post-retention | C | `gh api …/cache/usage` @ rev 26: **~9.7 GiB / 195 entries** — retention ran but still >8 GiB budget |

#### Rev 26 delta @ [`ede98a42`](https://github.com/tailrocks/velnor/commit/ede98a42) (2026-09-16 evening)

| Claim | Verdict | Evidence |
| --- | --- | --- |
| ci-main streak 3× green | C | **2/3** — success [35096781382](https://github.com/tailrocks/velnor/actions/runs/35096781382), [35097924422](https://github.com/tailrocks/velnor/actions/runs/35097924422); failure [35097942733](https://github.com/tailrocks/velnor/actions/runs/35097942733) `velnor-runner/Velnor` runner disconnect |
| Maintenance retention EXECUTED | V | [35103870683](https://github.com/tailrocks/velnor/actions/runs/35103870683): full pipeline, 10 evictions, `failed_evictions=0` |
| Cache ≤ 8 GiB after maintenance | C | pre-eviction `total_bytes=11164332683`; live post-run **~9.7 GiB** — still over budget |
| Phase 4 7× daily streak | C | **1/7** valid run with `failed_evictions=0`; `total_bytes` still >8 GiB |
| Runner infra flake (disconnect) | C | [35097942733](https://github.com/tailrocks/velnor/actions/runs/35097942733), [35099877819](https://github.com/tailrocks/velnor/actions/runs/35099877819): Velnor lane runner lost communication — rerun-class, not code |

#### Rev 26 delta @ [`5623be55`](https://github.com/tailrocks/velnor/commit/5623be55) (2026-09-16)

| Claim | Verdict | Evidence |
| --- | --- | --- |
| PR [#894](https://github.com/tailrocks/velnor/pull/894) fleet-final convergence | V | merged @ [`5623be55`](https://github.com/tailrocks/velnor/commit/5623be55): pin [`0084d561`](https://github.com/tailrocks/velnor/commit/0084d561); supersedes #893 @ [`0936b941`](https://github.com/tailrocks/velnor/commit/0936b941) |
| PR [#891](https://github.com/tailrocks/velnor/pull/891) maintenance `--repo` gate | V | merged 2026-09-16T11:47:20Z @ [`d2e23dd2`](https://github.com/tailrocks/velnor/commit/d2e23dd2): `maintenance.yml` `cache-budget` passes `--repo "$GITHUB_REPOSITORY"` to `velnor-workflow cache-plan`; supersedes [35091390936](https://github.com/tailrocks/velnor/actions/runs/35091390936) `--repo` bug @ [`20221ab2`](https://github.com/tailrocks/velnor/commit/20221ab2) |
| Maintenance retention post-#891 | V | [35103870683](https://github.com/tailrocks/velnor/actions/runs/35103870683): full pipeline EXECUTED, 10 evictions, `failed_evictions=0`; prior runs SKIPPED (ci-main in_progress) |
| Live GHA cache account | C | post-retention **~9.7 GiB / 195 entries** — retention ran but still exceeds 8 GiB budget |
| macOS on-demand host 4/4 | V | verified ~16:00 UTC+7: `velnorctl host start --name mac-1 --slots 4` → **4/4** `mac-1-{0..3}` online (PID **83457**); stale JIT markers cleared; supersedes rev 22 "all offline" |
| macOS on-demand host @ rev 26 live | C | `gh api …/actions/runners` @ rev 26: **0/4** `mac-1` online, `velnorctl host status` → `active_hosts: 0` — host stopped since 4/4 verification |
| §16 Phase 0 gate: 3× consecutive green `ci-main` | C | streak **2/3** @ rev 26 — [35096781382](https://github.com/tailrocks/velnor/actions/runs/35096781382)+[35097924422](https://github.com/tailrocks/velnor/actions/runs/35097924422) success; broken @ [35097942733](https://github.com/tailrocks/velnor/actions/runs/35097942733) runner disconnect |
| operational_store RCA | V | **Fleet infra, not workflow:** `record_admission()` fail-closed @ `ops.rs:532-597` before capability validation; Sentry dogfood on **v0.1.274** (2026-09-06) lacks [`7ab8d438`](https://github.com/tailrocks/velnor/commit/7ab8d438) per-job `JobMaskScope` mask scoping → long-lived slot workers exhaust mask registry → `store.masks` rejection; intermittent partial-run pattern (e.g. [35090384230](https://github.com/tailrocks/velnor/actions/runs/35090384230): 7 rejected / 8 passed Velnor jobs); fix published: **v0.1.275** @ [`66cfa4fa`](https://github.com/tailrocks/velnor/commit/66cfa4fa) (#896) — **deploy pending** on Sentry |
| PR [#896](https://github.com/tailrocks/velnor/pull/896) v0.1.275 release | V | merged @ [`66cfa4fa`](https://github.com/tailrocks/velnor/commit/66cfa4fa): `velnor-runner` **0.1.275** includes [`7ab8d438`](https://github.com/tailrocks/velnor/commit/7ab8d438) mask scoping fix for operational_store RCA |
| §16 Phase 0 gate: `actions/cache/usage` ≤ 8 GiB | C | retention EXECUTED [35103870683](https://github.com/tailrocks/velnor/actions/runs/35103870683); live **~9.7 GiB** — still over budget |
| Rev 22 historical ledger (#878/#879 regression) | V | #878/#879 @ [`1279c4f9`](https://github.com/tailrocks/velnor/commit/1279c4f9) broke Phase 0 (Policy 9 findings, monolithic nightly 1802 lines); restored via #884 @ [`285f2cdb`](https://github.com/tailrocks/velnor/commit/285f2cdb); 3× green streak historical @ rev 20 ([35066240941](https://github.com/tailrocks/velnor/actions/runs/35066240941), [35069637566](https://github.com/tailrocks/velnor/actions/runs/35069637566), [35070325902](https://github.com/tailrocks/velnor/actions/runs/35070325902)) |

#### Rev 27 delta @ [`776c84c7`](https://github.com/tailrocks/velnor/commit/776c84c7) (2026-09-16 evening)

| Claim | Verdict | Evidence |
| --- | --- | --- |
| #899 unreachable pin `92a2b13b` | C | [35106581996](https://github.com/tailrocks/velnor/actions/runs/35106581996): Policy **FAIL** `pin-reachable` — pin not in main history |
| #898 mold fix + reachable pin | V | [`9466fc71`](https://github.com/tailrocks/velnor/commit/9466fc71)+[`776c84c7`](https://github.com/tailrocks/velnor/commit/776c84c7): pin `9466fc71` reachable; local policy 11/11 |
| ci-main streak 3× green | C | **0/3** — [35100329067](https://github.com/tailrocks/velnor/actions/runs/35100329067) last green; 4× subsequent failures (operational_store, runner disconnect, pin-reachable) |
| Maintenance retention run 2 | U | [35105803721](https://github.com/tailrocks/velnor/actions/runs/35105803721): steps 6–11 EXECUTED, 4 evictions, `failed_evictions=0`, **enforce failed** (~996 MiB over budget) |
| Phase 4 7× daily streak | C | **1/7** valid ([35103870683](https://github.com/tailrocks/velnor/actions/runs/35103870683) only) |
| operational_store blocking CI | C | 6 rejections on [35105373458](https://github.com/tailrocks/velnor/actions/runs/35105373458); v0.1.275 merged but **not deployed** to Sentry dogfood |
| Fleet capacity | C | 2/2 dogfood slots busy, 0 idle; mac-1 0/4 offline |
| #891 cache-plan --repo claim | C | **Doc drift** — #891 only fixed `gh run list --repo` gate; `cache-plan` never had `--repo` (by design — entries from `gh api repos/$GITHUB_REPOSITORY`) |

#### Rev 28 delta @ [`b9c3156c`](https://github.com/tailrocks/velnor/commit/b9c3156c) (2026-09-16 evening)

| Claim | Verdict | Evidence |
| --- | --- | --- |
| main HEAD @ `b9c3156c` | V | docs-only plan commit; code pin landed via #902 @ [`9d9ef5b9`](https://github.com/tailrocks/velnor/commit/9d9ef5b9) |
| Pin `92c34786` | V | `.github-gen/velnor-workflow.toml:9`; #900 @ [`92c34786`](https://github.com/tailrocks/velnor/commit/92c34786) syncs to [`541d8926`](https://github.com/tailrocks/velnor/commit/541d8926) (#899); #902 fleet merge |
| ci-main streak 3× green | C | **0/3** — last green [35100329067](https://github.com/tailrocks/velnor/actions/runs/35100329067); **7×** failure since; **4 queued** ([35109846029](https://github.com/tailrocks/velnor/actions/runs/35109846029) @ `92c34786`, [35112453677](https://github.com/tailrocks/velnor/actions/runs/35112453677) @ `9d9ef5b9`, [35113415790](https://github.com/tailrocks/velnor/actions/runs/35113415790), [35113682015](https://github.com/tailrocks/velnor/actions/runs/35113682015) @ `b9c3156c`) |
| [35109161987](https://github.com/tailrocks/velnor/actions/runs/35109161987) @ [`776c84c7`](https://github.com/tailrocks/velnor/commit/776c84c7) RCA | V | Velnor `operational_store` rejections: `Control / Prepare Cargo`, `Docker · Docker / Velnor`; GitHub `Rust · velnor-workflow`: test `default_rows_render_the_legacy_release_surface` **FAILED** (1/468); `ci-required`/`Control / Required` red |
| Maintenance since rev 27 | V | PR success [35109165192](https://github.com/tailrocks/velnor/actions/runs/35109165192), [35109835682](https://github.com/tailrocks/velnor/actions/runs/35109835682); pending [35113416155](https://github.com/tailrocks/velnor/actions/runs/35113416155), [35113757030](https://github.com/tailrocks/velnor/actions/runs/35113757030); enforce streak still **1/7** |
| Cache ≤ 8 GiB | C | live **~10.5 GiB / 111 entries** (`11239879566` bytes) — still over budget |
| operational_store / v0.1.275 deploy | C | v0.1.275 merged #896 but **not deployed** to Sentry dogfood; Velnor lanes still reject at admission |
| Fleet capacity | V | 5/5 dogfood slots **online idle** (all `velnor-host-docker`); mac-1 0/4 offline; 3 recovery slots offline |
