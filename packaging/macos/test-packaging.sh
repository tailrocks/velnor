...
grep -F 'PACKAGING_COMMIT = "fb77e44e548e8d79ad7e0b71b4860f4ceefef679"' "$formula" >/dev/null
grep -F 'LAUNCH_SHA256 = "e86fbd6a6af01c75bd535f070735f8387829ee5d765c4ccf92405796dc9d5efc"' "$formula" >/dev/null
