...
grep -F 'SOURCE_COMMIT = "e5a0c249157a6fa79e82b502843fef945030d225"' "$formula" >/dev/null
grep -F 'SOURCE_ARCHIVE_SHA256 = "fb4dfd4a2e824d65ddebd597648c20d154a755bef23fd39afc71e5b134fe7dfa"' "$formula" >/dev/null
grep -F 'PACKAGING_COMMIT = "cce2bc61d3d446797d857ca09202ade99c54615a"' "$formula" >/dev/null
grep -F 'LAUNCH_SHA256 = "f025ac790fd3395e09c6fbb5c9e12e4db71eefc6d73c76371efa749414d65eaf"' "$formula" >/dev/null
