...
const VELNOR_WORKFLOW_SOURCE_REV: &str = "ba6ff17be548f7885622d481ad0d3ff62b721e24";
        ...
        if unit.kind == UnitKind::Rust {
            ...
            if unit.root == "." {
                unit.watch = vec![
                    ...
                    "Cargo.lock".to_owned(),
                    "rust-toolchain.toml".to_owned(),
                    "docker/build-mise.toml".to_owned(),
                    "docker/build-mise.lock".to_owned(),
                    "crates/**".to_owned(),
                    "microvm/**".to_owned(),
                    "tools/**".to_owned(),
                ];
...
impl WorkflowIr {
    ...
    fn render_tool_provisioning(&self, output: &mut String, lane: RunnerMode, unit: &Unit) {
        let tools = Self::tools_for_unit(unit, self.mise_rust, self.mr_boxington);
...
fn render_release_unit_jobs(config: &ProjectConfig) -> (String, Vec<String>) {
    ...
    for lane in lanes {
            ...
            .filter(|unit| lane_supports_unit(lane, unit))
        {
            ...
            workflow.render_tool_provisioning(&mut output, lane, unit);
...
"#,
    ...
    #[test]
    fn mbx_command_rewrite_preserves_non_cargo_commands() {
