...
/// or reuse a revision.
pub const GENERATOR_REVISION: &str = "42";
...
fn builtin_generated_actions() -> BTreeMap<PathBuf, String> {
    let content = include_str!("../templates/report-velnor-ci-outcomes/action.yml").to_owned();
    let mut files = BTreeMap::new();
    files.insert(
...
fn report_velnor_ci_outcomes_action_template() -> String {
    include_str!("../templates/report-velnor-ci-outcomes/action.yml").to_owned()
}
