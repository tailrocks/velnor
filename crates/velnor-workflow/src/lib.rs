...
/// or reuse a revision.
pub const GENERATOR_REVISION: &str = "3";
    ...
    for workflow_file in &config.workflow_files {
        ...
        let content = config
            ...
            .or_else(|| match workflow_file.as_str() {
                ...
                "velnor-workflow-policy.yml" => Some(generated_velnor_workflow_policy(config)),
...
fn generated_velnor_workflow_policy(config: &ProjectConfig) -> String {
    primitives::release::policy_provider_content(config)
}
...
mod tests {
    ...
    fn hosted_runtime_setup_uses_the_versioned_setup_action() {
        ...
        let policy = crate::primitives::release::policy_provider_content(&config);
...
"##;
    ...
    fn velnor_generator_owns_every_current_workflow() {
        ...
        assert_eq!(config.workflow_files.len(), 9);
