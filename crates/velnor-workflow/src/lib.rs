...
const VELNOR_POLICY_WORKFLOW_REV: &str = "845d76d7c887d46aa7c767d3d5d3b2f044b8c7bf";
...
const VELNOR_WORKFLOW_SOURCE_REV: &str = "845d76d7c887d46aa7c767d3d5d3b2f044b8c7bf";
...
"##;
    ...
    fn generated_maintenance_stays_github_hosted_when_runners_are_velnor() {
        ...
        assert_eq!(
            ...
            [
                "runs-on: ubuntu-24.04",
                "runs-on: [self-hosted, example-runner-label]",
            ],
    ...
    fn generated_planning_stays_github_hosted_when_runners_are_velnor() {
        ...
        assert_eq!(
            ...
            ["runs-on: [self-hosted, example-runner-label]"],
            "Planning must stay on the Velnor default lane: {plan}"
        );
