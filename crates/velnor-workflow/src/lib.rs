...
/// or reuse a revision.
pub const GENERATOR_REVISION: &str = "21";
...
const VELNOR_POLICY_WORKFLOW_REV: &str = "02651ef94ee689994106f7893801f74b808eb828";
...
const VELNOR_WORKFLOW_SOURCE_REV: &str = "02651ef94ee689994106f7893801f74b808eb828";
...
"##;
    ...
    fn apple_units_install_the_runtime_through_the_setup_action() {
        ...
        assert!(
            ...
            "Apple jobs install the runtime, they cannot download a macOS plan artifact: {surface}"
        );
        assert!(
    ...
    fn explicit_runner_modes_select_exact_trusted_ci_lanes() {
        ...
        assert!(velnor.contains("github.event_name == 'pull_request'"));
