...
/// or reuse a revision.
pub const GENERATOR_REVISION: &str = "43";
...
const VELNOR_POLICY_WORKFLOW_REV: &str = "8decfeeb8599345c4d047301550ffd0e894fc06f";
...
const VELNOR_WORKFLOW_SOURCE_REV: &str = "8decfeeb8599345c4d047301550ffd0e894fc06f";
...
fn run_installed_policy(root: &Path, revision: &str) -> Result<(), GeneratorError> {
    let install_root = env::temp_dir().join(format!("velnor-workflow-policy-{revision}"));
