...
/// or reuse a revision.
pub const GENERATOR_REVISION: &str = "49";
...
mod tests {
    ...
    fn velnor_provisioner_reuses_the_slot_only_on_manifest_digest_match() {
        ...
        assert!(
            step.contains("gh attestation verify \"$temporary/manifest.json\" --owner tailrocks --signer-repo tailrocks/velnor --signer-workflow tailrocks/velnor/.github/workflows/ci-runtime-products.yml"),
    ...
    fn setup_action_acquires_a_product_and_never_compiles() {
        ...
        assert!(action.contains("--signer-repo"), "{action}");
        assert!(
