...
pub(crate) const FLEET_CALLER_HEADER: &str =
...
pub(crate) const OWNERSHIP_STATE_HEADER: &str = "# Generated ownership state; do not edit.\n";
...
fn scan_target(
    ...
    // Static files are generator-owned outputs even when their verbatim body
    // carries no generated header. Pass their declared output paths to the
    // scanner so the first regeneration and every later scan use the same
    // provenance boundary.
    let generator_owned = generation
        .as_ref()
        .map(|generation| {
            generation
                .static_files()
        ...
        .unwrap_or_default();
    let shape = scan::scan_shape_with_owned(
        root,
        &scan_providers,
        scan_default_branch,
        exclude,
...
",
    ...
    fn generated_output_churn_is_not_scan_provenance_but_handwritten_github_is() {
        ...
        .inputs
        .scan;
        let generated = root.join(".github/workflows/generated-churn.yml");
        must(
            fs::create_dir_all(must_some(generated.parent(), "generated workflow parent")),
            "create generated workflow directory",
        );
        must(
            fs::write(&generated, GENERATED_HEADER),
            "write generated workflow",
        );
        let with_generated = must(
            scan_target(&root, provider.clone(), "main"),
            "scan with generated workflow",
        )
        .inputs
        .scan;
        assert_eq!(
            with_generated, initial,
            "generated output changed scan input"
        );
        must(fs::remove_file(&generated), "remove generated workflow");
        let after_generated = must(
            scan_target(&root, provider.clone(), "main"),
        ...
        .scan;
        assert_eq!(
            after_generated, initial,
            "generated removal changed scan input"
        );
