...
mod tests {
    ...
    fn test_inputs() -> crate::s2::GenerationInputs {
    ...
    fn config() -> crate::s2::ProjectConfig {
    ...
    fn check_drift_is_a_result_state_not_a_write_error() {
        let mut app = configured_app();
        let plan = crate::s2::GeneratedWritePlan {
            files: vec![crate::s2::PlannedFile {
                path: PathBuf::from(crate::s2::OWNERSHIP_STATE),
                action: crate::s2::PlannedAction::Update,
    ...
    fn changed_preflight_returns_to_review_for_confirmation() {
        let mut app = configured_app();
        let updated_plan = crate::s2::GeneratedWritePlan {
            files: vec![crate::s2::PlannedFile {
