...
mod tests {
    ...
    use super::{
        ...
        ProviderSet, RequiredCaller, RustNeeds, RustToolchain, Unit, UnitKind, WorkflowIr,
        WorkflowKind, XcodeToolchain, REQUIRED_CHECK,
    };
