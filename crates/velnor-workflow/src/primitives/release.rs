...
mod tests {
    ...
    fn default_rows_render_the_legacy_release_surface() {
        const PINNED: &[(&str, &str)] = &[
            (
                "release.yml",
                "97774de1e1bb652573d04de92bf78fbbb8120d5bf331ebaa5ba13c5c9fd54b17",
            ),
            (
                "preview.yml",
    ...
    fn identity_rows_render_the_pinned_native_surface() {
        const PINNED: &[(&str, &str)] = &[
            (
                "release.yml",
                "f0ff286334708724161680e986e4ea1f50c02ee62994720183740c8a5f8929a2",
            ),
            (
                "preview.yml",
    ...
    fn a_declared_native_release_admits_github_writer_only() {
        for (name, package, image, consumer) in [
            ...
            assert!(release.contains("name: Control / Admit release"), "{release}");
            assert!(
