...
const GENERATED_OWNER_LANE_CONTRACTS: [GeneratedOwnerLaneContract; 3] = [
    GeneratedOwnerLaneContract {
        ...
        lane_expression: "${{ github.event_name == 'workflow_dispatch' && inputs.lanes || (github.event_name == 'pull_request' || github.event_name == 'merge_group' || github.event_name == 'push') && 'github' || github.repository_owner == 'jackin-project' && 'github' || 'velnor' }}",
    },
    GeneratedOwnerLaneContract {
        owner: "tailrocks",
...
jobs:
  jackin-project:
    ...
    with:
      lane: ${{ github.event_name == 'workflow_dispatch' && inputs.lanes || (github.event_name == 'pull_request' || github.event_name == 'merge_group' || github.event_name == 'push') && 'github' || github.repository_owner == 'jackin-project' && 'github' || 'velnor' }}
  tailrocks:
