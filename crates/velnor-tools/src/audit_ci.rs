...
fn generated_caller_sample(
    ...
    if !bytes.starts_with(b"# Generated by velnor-workflow. Regenerate; do not hand-edit.\n") {
        return Ok(None);
    }
...
fn is_generated_caller(text: &str) -> bool {
    text.starts_with("# Generated by velnor-workflow. Regenerate; do not hand-edit.\n")
}
...
"#;
    ...
    const GENERATED_CALLER: &str = r#"# Generated by velnor-workflow. Regenerate; do not hand-edit.
on:
  push:
  schedule:
    - cron: "23 3 * * 0"
