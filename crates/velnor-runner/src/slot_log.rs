...
//!
//! Incident analysis must be possible from on-disk logs alone (see
//! docs/verification/evidence-record-2026-09-01.md): every broker poll outcome, control message, token refresh, registry
