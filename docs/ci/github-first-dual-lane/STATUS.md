...
| Session registry | `session.json`, SHA-256 `a60b01155210c8f6d5db9ddb48375c487baf4cbb788cb39116a9e6e3c5ebcd4f` | Actual Luna/max worker threads and evidence paths recorded; no gate pass |
