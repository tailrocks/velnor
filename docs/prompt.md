...
| 057 | BLOCKED | Tablerock repository instructions require trunk-only delivery and the old plan would delete newer coverage. Do not force the obsolete branch template. |
