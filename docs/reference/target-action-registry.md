...
|--------|------|------|-------|------------------|--------|-------------------|
| `actions/checkout` | [actions/checkout](https://github.com/actions/checkout) | TS | `v5` | <https://github.com/actions/checkout/tree/v5> | [releases](https://github.com/actions/checkout/releases) | ref, `fetch-depth`, `submodules`, `persist-credentials`, token masking, external/selected-repo checkout |
