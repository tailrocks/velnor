...
3. stream or append logs per step: current code captures stdout/stderr after each executed script or JavaScript step and appends masked lines to timeline feed records after the job container run.
