...
The workspace is split into model, control, client, render, runner, and CLI crates. The runner is the self-hosted Actions runtime; its public boundary exposes configuration, execution, node, protocol, runner, and service modules. Its migration scaffold is explicitly temporary, not a compatibility promise. (`Cargo.toml:1-19`, `crates/velnor-model/src/lib.rs:1-5`, `crates/velnor-control/src/lib.rs:1-5`, `crates/velnor-client/src/lib.rs:1-5`, `crates/velnor-render/src/lib.rs:1-8`, `crates/velnor-runner/src/lib.rs:1-63`)
