...
| `actions/download-artifact` | `DownloadArtifact` | `name`, `pattern`, all-artifacts mode, `path`, `merge-multiple`, latest directory layout semantics, same-run cross-job handoff on one Velnor host |
