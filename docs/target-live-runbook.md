...
runner labels, run artifacts, job steps, a bounded first/last-line log excerpt,
and a bounded snapshot of Velnor's local `_velnor_caches`, `_velnor_artifacts`,
and `_velnor_sccache` directories under the shared work directory. Set
