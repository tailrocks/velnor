...
- stdout/stderr from executed script and JavaScript steps is captured and uploaded to GitHub timeline feed records after execution, with GitHub/job/add-mask masks applied
